...
LOCAL_SRC_FILES := libfiles/$(TARGET_ARCH_ABI)/libcurl.a
...
LOCAL_SRC_FILES := libfiles/$(TARGET_ARCH_ABI)/libcrypto.a
include $(PREBUILT_STATIC_LIBRARY)

LOCAL_MODULE := cocos_ssl_static
LOCAL_MODULE_FILENAME := ssl
LOCAL_SRC_FILES := libfiles/$(TARGET_ARCH_ABI)/libssl.a
include $(PREBUILT_STATIC_LIBRARY)
